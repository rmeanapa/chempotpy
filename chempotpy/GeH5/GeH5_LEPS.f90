...
!   Common name:      GeH5
!   References:       J. Espinosa-Garcia, J. Chem. Phys., Vol. 111, p. 9330, 1999.
! Notes: This routine requires the utility 'utility.f' located in the
!        'utilities' section of POTLIB-online.
...
! calculates reference angles for the "in-plane" potential
...
! to calculate leps-type stretching potential and its derivatives
...
C
       ...
       REF(2)='J. Chem. Phys., Vol. 111, p. 9330, 1999'
C
      INDEXES(1) = 1
      INDEXES(2) = 32
      INDEXES(3) = 1
...
C
       ...
       DATA fch3    /   0.0157500d0/
       DATA hch3    /   0.1915000d0/
       DATA fkinf   /   0.3058900d0/
       DATA ak      /   0.1260000d0/
       DATA bk      /  50.7132d0/
       DATA aa1     /   3.213952d0/
       DATA aa2     /   1.599963d0/

...
!   Common name:
!
!   References:    J. C. Corchado, J. Espinosa-Garcia, O. Roberto-Neto, Y.-Y. Chuang,
!                  and D. G. Truhlar, J. Phys. Chem., Vol. 102, p. 4899, 1998.
!
...
C                                                                               
      ...
      CALL CARTTOR                                                              
c                                                                               
C Changing to angstroms and initialize                                          
C                                                                               
      DO 10 I = 1, 18    
         q(I) = R(I)                                                      
c         q(I) = R(I)*0.52918d0                                                  
...
c                                                                               
      ...
      IF(NDER.NE.0) THEN                                                        
c                                                                               
c  copy the pdots to the appropriate elements in dv. dx in POLYRATE.            
C  Reordering and transformation from 10(5)j/mol/A to au                        
C                                                                               
         do ind=1,3                                                             
            DEGSDR(ind)=pdot(nh(4,ind))*0.0201723d0                             
         enddo                                                                  
         do ind=1,3                                                             
            DEGSDR(ind+3)=pdot(nc(ind))*0.0201723d0                             
         enddo                                                                  
         do ind=1,3                                                             
            DEGSDR(ind+6)=pdot(nh(1,ind))*0.0201723d0                           
         enddo                                                                  
         do ind=1,3                                                             
            DEGSDR(ind+9)=pdot(nh(2,ind))*0.0201723d0                           
         enddo                                                                  
         do ind=1,3                                                             
            DEGSDR(ind+12)=pdot(nh(3,ind))*0.0201723d0                          
         enddo                                                                  
         do ind=1,3                                                             
            DEGSDR(ind+15)=pdot(nhb(ind))*0.0201723d0                           
         enddo                                                                  
         CALL RTOCART                                                           
         CALL DEDCOU                                                            
      ENDIF                                                                     
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='Jordan and Gilbert,'                                             
       REF(2)='J. Chem. Phys. 102, 5669(1995)'                                  
C                                                                               
      INDEXES(1) = 1                                                            
      INDEXES(2) = 6                                                            
      INDEXES(3) = 1                                                            
